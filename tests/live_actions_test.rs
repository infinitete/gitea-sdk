...
use gitea_sdk::options::action::{ListRepoActionJobsOptions, ListRepoActionRunsOptions};
use gitea_sdk::options::repo::{CreateFileOptions, EditRepoOption, FileOptions};
...
async fn wait_for_deletable_run(
    ...
    repo: &str,
    run_id: i64,
) -> Result<Option<gitea_sdk::Response>, Error> {
    for _ in 0..30 {
        match client
            .actions()
