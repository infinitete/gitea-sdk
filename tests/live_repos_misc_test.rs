...
use gitea_sdk_rs::types::enums::GitServiceType;
...
async fn live_repos_misc_flow() {
    ...
    let (migrate_source, migrate_source_resp) = client
        .repos()
        .create_repo(gitea_sdk_rs::options::repo::CreateRepoOption {
            ...
            trust_model: gitea_sdk_rs::types::enums::TrustModel::Default,
